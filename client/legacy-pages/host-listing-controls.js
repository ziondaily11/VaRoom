(function () {
  ...
  window.VaRoomHostListings = { bind: bind, menu: function (listing) {
    ...
    return '<div class="card-menu-wrap"><button type="button" class="card-menu-btn" data-menu-toggle="' + listing.id + '" aria-label="Manage listing"><svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="5" r="1.8"/><circle cx="12" cy="12" r="1.8"/><circle cx="12" cy="19" r="1.8"/></svg></button><div class="card-menu-dropdown" id="menu-' + listing.id + '">' +
