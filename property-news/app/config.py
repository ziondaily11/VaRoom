...
class Settings:
    ...
    ai_provider: str = os.getenv("NEWS_AI_PROVIDER", "rules").lower()
    ai_api_key: str | None = os.getenv("NEWS_AI_API_KEY") or None
    ai_model: str | None = os.getenv("NEWS_AI_MODEL") or None
